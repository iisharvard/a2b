...
`;
  ...
  // Automatically generate shared content if the party1 and party2 data is populated
  // and we haven't generated content yet
  useEffect(() => {
    ...
    if (hasParty1Data && hasParty2Data && hasNoDefaultContent && sharedHasOnlyDefaults && !autoGeneratedShared && !isGeneratingShared) {
      // Auto-generate shared content after a brief delay to let UI render first
